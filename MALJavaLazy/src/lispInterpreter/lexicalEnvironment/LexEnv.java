...
public class LexEnv {
	 ...
	 */
	public void putSymbol(String s, Expression e, LexEnv env) {
...
//		}
	...
	public void setq(String s, Expression e, LexEnv env) {
		e.setEnv(env);
		map.put(s+"-value", e);
	}
	 ...
	 */
	public void putValue(String s, Expression e, LexEnv env) {
	...
	public Expression getValue(String s) {
		if (map.containsKey(s + "-value")) {
			Expression rtrn = map.get(s + "-value");
			return rtrn.eval(rtrn.getEnv(), false);
		}
		return null;
	}
